...
class Level2:
    def __init__(self):
        ...
        self.enemy5.enemy_speed = 3
        self.enemy6.enemy_speed = 3
        self.enemy7.enemy_speed = 3
        self.enemy8.enemy_speed = 3
        self.enemy9.enemy_speed = 3
        self.enemy10.enemy_speed = 3
        self.enemy11.enemy_speed = 3
        self.enemy12.enemy_speed = 3
        self.tile_rect = []
