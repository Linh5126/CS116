...
def main():
    ...
    if level_name not in LEVEL_MAP:
        print("❌ Level không hợp lệ. Chọn: level1, level2, level3")
        return
    ...
    elif isinstance(level_class(), Level3AI): final_chart_path = f"plots/dqn_vs_db_dqn_lv3_{num_games}.png"
    plot_dual_mean_scores(mean_scores_dqn, mean_scores_ddqn, total_dqn, total_ddqn, label1='DQN', label2='Double DQN', save_path=final_chart_path)
