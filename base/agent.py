...
def train(game=Level2AI(), num_games=1000):
    ...
    elif isinstance(game, Level3AI): agent.load_state("training_state_dqn_lv3.pkl")
    a= 'DQN'
    frames = []
    while True:
        ...
        if done:
            ...
            if score > record:
                ...
                if isinstance(game, Level1AI): 
                    ...
                    last_best_video = f"videos1/best_gamelv3_dqn_{agent.n_games}.mp4"
                    save_video_from_frames(frames, last_best_video)
    ...
    elif isinstance(game, Level3AI): final_chart_path = f"plots/dqn_lv3_{num_games}.png"
